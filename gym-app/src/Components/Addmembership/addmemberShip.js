    ...
    <div className="text-black">
      <div className="flex flex-wrap gap-5 items-center justify-center">
        {membership.map((item, index) => {
          return (
            <div className="text-lg bg-black text-white border-2 pl-2 pr-2 flex-col gap-3 justify-between pt-1 pb-1 rounded-xl font-semibold hover:bg-gradient-to-r from-red-600 via-orange-500  to-black">
      ...
      <div className="flex gap-10 mb-10">
        ...
        <div
          ...
          className="text-lg border-2 p-1 w-auto mt-0 rounded-xl cursor-pointer hover:bg-gradient-to-r from-red-600 via-orange-500  to-black"
        >
          {" "}
          Add +
        </div>
