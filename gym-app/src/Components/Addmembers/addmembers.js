...
const Addmembers = () => {
  const [inputField, setInputField] = useState({
    ...
    membership: "",
    profilePic:
      "https://tse2.mm.bing.net/th/id/OIP.VAXXfFH7RqDL8my5b-TaTQHaHa?rs=1&pid=ImgDetMain&o=7&rm=3",
    joiningDate: "",
  });
    ...
    <div className="text-black">
      <div className="grid gap-5 grid-cols-2 text-lg">
        ...
        <div
          ...
          className="p-3 border-2 w-28 text-lg h-14 text-center bg-slate-900 text-white rounded-xl cursor-pointer hover:bg-gradient-to-r from-red-600 via-orange-500  to-black"
        >
          Register
        </div>
      </div>
